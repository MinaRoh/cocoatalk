...
public class ChatClient extends JFrame implements ActionListener, Runnable, ListSelectionListener, MouseListener {
	...
	public void JTableRefresh2(String line) {// 친구 검색시 테이블
		...
		//frSearch.table.getColumn("온라인표시").setPreferredWidth(5);
		//frSearch.table.getColumn("닉네임").setPreferredWidth(30);
		//frSearch.table.getColumn("한마디").setPreferredWidth(200);
	}
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == loginUI.btnSignIn) { // 회원가입 버튼
			...
			if (userName.compareTo(nName) == 0 || condition_nName) {
				...
				condition_nName = false;				
				JOptionPane.showMessageDialog(this, "변경을 완료하였습니다.");
			} else {
			...
			int result = JOptionPane.showConfirmDialog(null, "탈퇴 하시겠습까?", "회원 탈퇴", JOptionPane.YES_NO_OPTION);
